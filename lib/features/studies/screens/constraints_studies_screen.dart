...
/// Studies screen for Day 2: The Protocol (Constraints & Sizes)
class ConstraintsStudiesScreen extends StatelessWidget {
  const ConstraintsStudiesScreen({super.key});
        ...
        child: Column(
          ...
          children: [
            ...
            _buildInfoCard(
              ...
              description: 'Parent tells child: You must be between min and max',
            ...
            _buildInfoCard(
              ...
              title: 'Sizes Come Up',
              description: 'Child reports back: I chose to be this size',
              color: AppColors.phase1Color,
            ),
            const SizedBox(height: 32),
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            'Test your understanding of BoxConstraints, LayoutBuilder, and the constraint protocol.',
            style: textStyles.regularBody14.copyWith(color: theme.textSecondary),
