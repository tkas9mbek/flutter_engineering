...
/// Studies screen for Day 6: Boundaries & Layers
class BoundariesStudiesScreen extends StatelessWidget {
  const BoundariesStudiesScreen({super.key});
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Minimize dirty regions and optimize repaints',
            ...
            _buildOptimizationCard(
              context,
              'RepaintBoundary',
              'Isolate repaints to specific subtrees',
              Icons.crop_square,
              AppColors.phase1Color,
            ),
            const SizedBox(height: 16),
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            'Test RepaintBoundary optimizations with real animations.',
            style: textStyles.regularBody14.copyWith(color: theme.textSecondary),
